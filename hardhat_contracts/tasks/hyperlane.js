const {
    chainMetadata,
    ChainName,
    hyperlaneCoreAddresses: HyperlaneCoreAddresses,
    MultiProvider,
    objMap,
} = require("@hyperlane-xyz/sdk");
const { utils } = require("@hyperlane-xyz/utils");
const { InterchainAccountRouter__factory } = require("@hyperlane-xyz/core");
require("@nomicfoundation/hardhat-toolbox");
require("@nomiclabs/hardhat-etherscan");
const { HardhatUserConfig, task, types } = require("hardhat/config");
const { ethers, Event } = require("ethers");
...
function getMessageIdFromDispatchLogs(logs) {
